...
<c:set var="pageTitle" value="Edit exam" />
  ...
  <div class="card-body p-4">
    ...
    <form action="${ctx}/admin/exams" method="post" novalidate>
      ...
      <div class="row g-3">
        <div class="col-md-4">
          ...
          <input type="number" min="1" class="form-control" id="durationMin" name="durationMin"
                 value="${exam.durationMin}" required>
        </div>
        <div class="col-md-4">
      ...
      <p class="text-muted small mt-3 mb-0">
        Editing does not change the exam's published status. Manage questions from
        the <a href="${ctx}/admin/allocate?examId=${exam.examId}">Questions</a> screen.
      </p>
    </form>
  </div>
</div>
